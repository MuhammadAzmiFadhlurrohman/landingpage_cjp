...
<body class="font-sans text-[15px] leading-relaxed antialiased text-[color:var(--ink)]">
    ...
    <!-- Sticky Navbar dengan High-Contrast Blur Glassmorphic Header -->
    <nav x-data="{ scrolled: false, mobileMenuOpen: false }"
         @scroll.window="scrolled = (window.pageYOffset > 20)"
         :class="{ 'bg-white/95 backdrop-blur-xl shadow-lg py-3 border-b border-sky-100 text-[color:var(--ink)]': scrolled, 'bg-[#06182c]/95 backdrop-blur-xl py-3.5 border-b border-sky-400/20 text-white shadow-xl': !scrolled }"
         class="fixed w-full top-0 z-50 transition-all duration-300">
        <div class="container mx-auto px-6 md:px-12 flex justify-between items-center">
            
            <!-- Logo Branding (Menggunakan White Pill Container agar Selalu Terlihat Jelas) -->
            <a href="#beranda" class="flex items-center gap-3 group bg-white/95 px-3.5 py-1.5 rounded-xl shadow-md border border-white/20 hover:scale-105 transition-transform duration-300">
                <img src="{{ asset('assets/cjp.png') }}" alt="Logo CJP" class="h-6 sm:h-8 w-auto object-contain">
            </a>

            <!-- Desktop Menu Navigation -->
            <div class="hidden md:flex space-x-6 items-center font-bold text-sm">
                <a href="#beranda" :class="scrolled ? 'text-gray-700 hover:text-[color:var(--sky-deep)]' : 'text-white hover:text-sky-300'" class="transition py-1 relative group">
                    Beranda
                ...
                <a href="#tentang" :class="scrolled ? 'text-gray-700 hover:text-[color:var(--sky-deep)]' : 'text-white hover:text-sky-300'" class="transition py-1 relative group">
                    Tentang Kami
                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-sky-400 to-teal-400 transition-all duration-300 group-hover:w-full"></span>
                </a>
                <a href="#produk" :class="scrolled ? 'text-gray-700 hover:text-[color:var(--sky-deep)]' : 'text-white hover:text-sky-300'" class="transition py-1 relative group">
                    Produk
                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-sky-400 to-teal-400 transition-all duration-300 group-hover:w-full"></span>
                </a>
                <a href="#portofolio" :class="scrolled ? 'text-gray-700 hover:text-[color:var(--sky-deep)]' : 'text-white hover:text-sky-300'" class="transition py-1 relative group">
                    Portofolio
                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-sky-400 to-teal-400 transition-all duration-300 group-hover:w-full"></span>
                </a>
                <a href="#klien" :class="scrolled ? 'text-gray-700 hover:text-[color:var(--sky-deep)]' : 'text-white hover:text-sky-300'" class="transition py-1 relative group">
                    Klien
                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-sky-400 to-teal-400 transition-all duration-300 group-hover:w-full"></span>
                </a>
                <a href="#faq" :class="scrolled ? 'text-gray-700 hover:text-[color:var(--sky-deep)]' : 'text-white hover:text-sky-300'" class="transition py-1 relative group">
                    FAQ
                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-sky-400 to-teal-400 transition-all duration-300 group-hover:w-full"></span>
                </a>
                <a href="#lokasi" :class="scrolled ? 'text-gray-700 hover:text-[color:var(--sky-deep)]' : 'text-white hover:text-sky-300'" class="transition py-1 relative group">
                    Lokasi
                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-sky-400 to-teal-400 transition-all duration-300 group-hover:w-full"></span>
                </a>
    ...
    <!-- Ringkas & Elegan Semi-Dark Jumbotron / Hero Section -->
    <section id="beranda" class="relative pt-28 pb-16 md:pt-36 md:pb-24 px-6 overflow-hidden border-b border-sky-900/50" style="background: linear-gradient(135deg, #071626 0%, #0B2446 45%, #113866 80%, #081B30 100%);">
        ...
        <!-- Ambient Glow Orbs -->
        <div class="absolute -top-32 left-1/4 w-[450px] h-[450px] bg-sky-500/20 rounded-full blur-[130px] pointer-events-none"></div>
        <div class="absolute top-1/3 right-10 w-[400px] h-[400px] bg-teal-400/20 rounded-full blur-[110px] pointer-events-none"></div>

        <div class="container mx-auto max-w-6xl relative z-10">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                
                <!-- Hero Text Content (Ringkas, Padat, Jelas) -->
                <div class="lg:col-span-7 text-center lg:text-left">
                    ...
                    <!-- Main Ringkas Headline -->
                    <h1 class="reveal active delay-100 font-display text-2xl sm:text-3xl md:text-4xl font-extrabold text-white mb-4 leading-tight tracking-tight">
                    ...
                    <!-- Ringkas Subtitle -->
                    <p class="reveal active delay-200 text-xs sm:text-sm text-sky-100/90 mb-6 max-w-lg mx-auto lg:mx-0 leading-relaxed font-medium">
                        Pemasangan perangkat jaringan (site installation), pemetaan lokasi telekomunikasi, dan pengelolaan perizinan proyek terpercaya di Indonesia.
                    </p>

                    <!-- Buttons CTA -->
                    <div class="reveal active delay-300 flex flex-col sm:flex-row gap-3 justify-center lg:justify-start items-center">
                        <a href="https://wa.me/6281283800066?text=Halo%20PT%20Connecti%20Jelajah%20Priangan,%20saya%20ingin%20konsultasi%20layanan%20jaringan" target="_blank" rel="noopener" class="btn-glow bg-gradient-to-r from-emerald-500 to-teal-600 text-white px-7 py-3 rounded-full font-bold text-xs shadow-xl flex items-center gap-2.5 hover:scale-105 active:scale-95 transition-all w-full sm:w-auto justify-center">
                            <i class="fa-brands fa-whatsapp text-lg"></i>
                            <span>Konsultasi WhatsApp</span>
                        </a>
                        <a href="#produk" class="px-7 py-3 rounded-full border border-white/25 text-white font-bold text-xs bg-white/10 backdrop-blur-md hover:bg-white/20 transition duration-300 w-full sm:w-auto text-center shadow-sm">
                            Katalog Layanan
                        </a>
                    </div>
                ...
                <div class="lg:col-span-5 reveal active delay-200 relative mt-4 lg:mt-0">
                    <div class="shine-card bg-white/10 backdrop-blur-2xl p-5 sm:p-6 rounded-3xl border border-white/20 text-white shadow-2xl relative z-10 overflow-hidden">
                        
                        <!-- Header Bar -->
                        <div class="flex justify-between items-center pb-3 mb-4 border-b border-white/15">
                            <div class="flex items-center gap-2">
                                <div class="w-2.5 h-2.5 rounded-full bg-rose-500/80"></div>
                                <div class="w-2.5 h-2.5 rounded-full bg-amber-500/80"></div>
                                <div class="w-2.5 h-2.5 rounded-full bg-emerald-500/80"></div>
                                <span class="text-[11px] font-bold text-sky-200 ml-1.5 font-mono">cjp-network-monitor</span>
                            </div>
                            <span class="px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-300 border border-emerald-400/30 text-[9px] font-extrabold uppercase tracking-wider flex items-center gap-1">
                        ...
                        <div class="grid grid-cols-2 gap-3 mb-4">
                            <div class="bg-white/10 backdrop-blur-md p-3.5 rounded-2xl border border-white/15">
                                <div class="flex items-center justify-between mb-0.5">
                                    <span class="text-[9px] font-bold uppercase tracking-wider text-sky-200">Download</span>
                                    <i class="fa-solid fa-arrow-down text-emerald-400 text-[10px]"></i>
                                </div>
                                <div class="font-display font-extrabold text-xl text-white">998.4 <span class="text-[10px] font-semibold text-sky-300">Mbps</span></div>
                            </div>
                            <div class="bg-white/10 backdrop-blur-md p-3.5 rounded-2xl border border-white/15">
                                <div class="flex items-center justify-between mb-0.5">
                                    <span class="text-[9px] font-bold uppercase tracking-wider text-sky-200">Upload</span>
                                    <i class="fa-solid fa-arrow-up text-sky-300 text-[10px]"></i>
                                </div>
                                <div class="font-display font-extrabold text-xl text-white">998.1 <span class="text-[10px] font-semibold text-sky-300">Mbps</span></div>
                            </div>
                        </div>

                        <!-- Live Signal Wave Graphic -->
                        <div class="bg-black/30 p-3 rounded-2xl text-white border border-white/10">
                            <div class="flex justify-between items-center text-[11px] mb-1">
                                <span class="font-semibold text-sky-200">Latency & Stability</span>
                                <span class="font-bold text-emerald-400 font-mono">&lt; 1.8 ms</span>
                            </div>
                            <svg class="w-full h-10" viewBox="0 0 300 50" fill="none">
