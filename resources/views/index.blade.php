...
<body class="font-sans text-[15px] leading-relaxed antialiased text-[color:var(--ink)]">
    ...
    <!-- Sticky Navbar Blur Glassmorphic Header (Dynamic Adaptive Logo) -->
    <nav x-data="{ scrolled: false, mobileMenuOpen: false }"
         @scroll.window="scrolled = (window.pageYOffset > 20)"
         :class="{ 'bg-white/95 backdrop-blur-xl shadow-md py-3 border-b border-sky-100 text-[color:var(--ink)]': scrolled, 'bg-[#06182c]/90 backdrop-blur-xl py-4 border-b border-white/10 text-white shadow-xl': !scrolled }"
         class="fixed w-full top-0 z-50 transition-all duration-300">
        <div class="container mx-auto px-6 md:px-12 flex justify-between items-center">
            
            <!-- Dynamic Logo: cjpputih.png on Jumbotron (Not Scrolled), cjp.png when Scrolled -->
            <a href="#beranda" class="flex items-center gap-3 group">
                <img src="{{ asset('assets/cjpputih.png') }}" :src="scrolled ? '{{ asset('assets/cjp.png') }}' : '{{ asset('assets/cjpputih.png') }}'" alt="Logo PT CJP" class="h-7 sm:h-9 md:h-10 w-auto max-w-[140px] sm:max-w-none object-contain group-hover:scale-105 transition-transform duration-300">
            </a>
    ...
    <section id="beranda" class="relative pt-32 pb-20 md:pt-40 md:pb-28 px-6 overflow-hidden border-b border-sky-900/50" style="background: linear-gradient(135deg, #06182C 0%, #0B2546 45%, #113866 80%, #081B30 100%);">
        ...
        <div class="container mx-auto max-w-6xl relative z-10">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
                ...
                <!-- Hero Text Content (Ringkas, Padat, Mewah) -->
                <div class="lg:col-span-7 text-center lg:text-left">
                    
                    <!-- Official Live Badge -->
                    <div class="reveal active inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full text-xs font-bold bg-white/10 backdrop-blur-md border border-white/20 text-sky-300 shadow-lg mb-5">
