...
<head>
    ...
    <style>
        ...
        .bg-gradient-produk {
            background-image:
                radial-gradient(60% 55% at 85% 10%, rgba(41,171,226,0.15) 0%, rgba(41,171,226,0) 60%),
                radial-gradient(50% 50% at 10% 90%, rgba(21,184,166,0.15) 0%, rgba(21,184,166,0) 60%),
...
<body class="font-sans text-[15px] leading-relaxed antialiased text-[color:var(--ink)]">
    ...
    <section id="produk" class="pt-24 pb-28 md:pb-36 bg-gradient-produk px-6 relative overflow-hidden">
        ...
        <div class="absolute inset-0 pointer-events-none overflow-hidden z-0 opacity-60">
