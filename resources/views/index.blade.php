...
<body class="font-sans text-[15px] leading-relaxed antialiased text-[color:var(--ink)]">
    ...
    <section id="portofolio" class="relative pt-12 pb-24 sm:pt-16 sm:pb-28 px-4 sm:px-6 overflow-hidden" style="background: linear-gradient(135deg, #081F38 0%, #0B2A4A 40%, #11426C 75%, #1C8AC0 100%);">
