...
<body class="font-sans text-[15px] leading-relaxed antialiased text-[color:var(--ink)]">
    ...
    <!-- Sticky Navbar Blur Glassmorphic Premium Header -->
    <nav x-data="{ scrolled: false, mobileMenuOpen: false }"
         @scroll.window="scrolled = (window.pageYOffset > 20)"
         :class="{ 'bg-white/95 backdrop-blur-xl shadow-md py-3 border-b border-sky-100': scrolled, 'bg-white/85 backdrop-blur-lg py-4 border-b border-sky-100/60': !scrolled }"
         class="fixed w-full top-0 z-50 transition-all duration-300">
        <div class="container mx-auto px-6 md:px-12 flex justify-between items-center">
            
            <!-- Logo Branding (Gambar Logo Asli Tanpa Kotak) -->
            <a href="#beranda" class="flex items-center gap-3 group">
                <img src="{{ asset('assets/cjp.png') }}" alt="Logo CJP" class="h-7 sm:h-9 md:h-10 w-auto max-w-[140px] sm:max-w-none object-contain group-hover:scale-105 transition-transform duration-300">
            </a>
    ...
    <!-- Modern Clean & Premium Hero Section -->
    <section id="beranda" class="relative pt-28 pb-16 md:pt-36 md:pb-24 px-6 overflow-hidden border-b border-sky-100" style="background: linear-gradient(135deg, #F8FAFC 0%, #E0F2FE 50%, #F0FDFA 100%);">
        
        <!-- Ambient Decorative Lighting Glow Orbs -->
        <div class="absolute -top-24 left-1/4 w-[450px] h-[450px] bg-[color:var(--sky)]/15 rounded-full blur-[130px] pointer-events-none"></div>
        <div class="absolute top-1/3 right-10 w-[400px] h-[400px] bg-[color:var(--teal)]/15 rounded-full blur-[110px] pointer-events-none"></div>

        <div class="container mx-auto max-w-6xl relative z-10">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
                
                <!-- Hero Text Content (Sangat Elegan, Ringkas & Mewah) -->
                <div class="lg:col-span-7 text-center lg:text-left">
                    
                    <!-- Official Badge -->
                    <div class="reveal active inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full text-xs font-bold bg-white/90 border border-sky-200 text-[color:var(--sky-deep)] shadow-xs mb-5">
                    ...
                    <!-- Main Headline -->
                    <h1 class="reveal active delay-100 font-display text-3xl sm:text-4xl md:text-5xl font-extrabold text-[color:var(--ink)] mb-5 leading-tight tracking-tight">
                        Infrastruktur Jaringan & <br>
                        <span class="bg-gradient-to-r from-[color:var(--sky)] via-[color:var(--sky-deep)] to-[color:var(--teal)] bg-clip-text text-transparent">Telekomunikasi Handal</span>
                    </h1>
                    ...
                    <p class="reveal active delay-200 text-sm sm:text-base text-gray-600 mb-8 max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium">
                        PT Connecti Jelajah Priangan (CJP) melayani pemasangan perangkat jaringan (site installation), pemetaan lokasi telekomunikasi, dan pengelolaan perizinan proyek terpercaya di Indonesia.
                    </p>

                    <!-- Buttons CTA -->
                    <div class="reveal active delay-300 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center mb-8">
                        <a href="https://wa.me/6281283800066?text=Halo%20PT%20Connecti%20Jelajah%20Priangan,%20saya%20ingin%20konsultasi%20layanan%20jaringan" target="_blank" rel="noopener" class="btn-glow bg-gradient-to-r from-emerald-500 via-teal-500 to-emerald-600 text-white px-8 py-3.5 rounded-full font-bold text-sm shadow-xl shadow-emerald-200 flex items-center gap-3 hover:scale-105 active:scale-95 transition-all w-full sm:w-auto justify-center">
                            <i class="fa-brands fa-whatsapp text-xl"></i>
                            <span>Konsultasi via WhatsApp</span>
                        </a>
                        <a href="#produk" class="px-8 py-3.5 rounded-full border border-sky-200 text-[color:var(--ink)] font-bold text-sm bg-white/80 hover:bg-sky-50 hover:border-sky-300 transition duration-300 w-full sm:w-auto text-center shadow-xs">
                            Katalog Layanan
                        </a>
                    </div>

                    <!-- 3 Key Features Highlights Bar -->
                    <div class="reveal active delay-400 flex flex-wrap justify-center lg:justify-start items-center gap-6 pt-6 border-t border-sky-200/70 text-xs font-semibold text-gray-600">
                        ...
                        <div class="flex items-center gap-2">
                            <span class="w-5 h-5 rounded-full bg-sky-100 text-[color:var(--sky-deep)] flex items-center justify-center text-[10px] font-bold">✓</span>
                ...
                <!-- Hero Visual Network Showcase Card (Right 5 Cols) -->
                <div class="lg:col-span-5 reveal active delay-200 relative mt-6 lg:mt-0">
                    <div class="shine-card bg-white/95 backdrop-blur-xl p-6 sm:p-7 rounded-3xl border border-sky-100 shadow-2xl relative z-10 overflow-hidden">
                        ...
                        <div class="flex items-center justify-between text-xs text-gray-600 bg-white p-3 rounded-xl border border-sky-100">
                            <div class="flex items-center gap-2">
                                <i class="fa-solid fa-award text-[color:var(--sky-deep)] text-base"></i>
                                <span class="font-bold text-[color:var(--ink)]">Lisensi Resmi APJATEL</span>
                            </div>
                            <span class="text-[11px] font-bold text-emerald-600 uppercase tracking-wider">Terdaftar</span>
                        </div>
