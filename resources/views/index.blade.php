...
<head>
    ...
    <style>
        ...
        /* Force Centered Swiper Pagination Dots */
        ...
        .swiper-pagination-portfolio .swiper-pagination-bullet-active {
            ...
            box-shadow: 0 0 10px rgba(41, 171, 226, 0.7) !important;
            transform: none !important;
        }

        .bg-gradient-produk {
            background-image:
                linear-gradient(180deg, rgba(6, 24, 44, 0.40) 0%, rgba(11, 42, 74, 0.25) 50%, rgba(8, 31, 56, 0.60) 100%),
                url('{{ asset('assets/bgproduk.jpg') }}?v=3');
        ...
        /* Curved Floating Notch Active Navigation Indicator (Downward for Top Navbar) */
        .nav-item-cjp {
            position: relative;
            display: inline-flex;
...
<body class="font-sans text-[15px] leading-relaxed antialiased text-[color:var(--ink)]">
    ...
    <nav x-data="{ mobileMenuOpen: false }"
        ...
        <div class="container mx-auto px-6 md:px-12 flex justify-between items-center">
            ...
            <!-- Desktop Menu Navigation with Dynamic Curved Floating Icon Notch Indicator (Downward Positioned) -->
            ...
            <button @click="mobileMenuOpen = !mobileMenuOpen" class="md:hidden p-2.5 rounded-xl bg-white border border-sky-100 text-gray-800 shadow-sm focus:outline-none transition active:scale-95">
    ...
    <!-- Semi-Dark Premium Jumbotron / Hero Section -->
    <section id="beranda" class="relative pt-28 pb-20 md:pt-36 md:pb-28 px-6 overflow-hidden" style="background: linear-gradient(135deg, #06182C 0%, #0B2546 45%, #113866 80%, #081B30 100%);">
        ...
        <div class="container mx-auto max-w-6xl relative z-10">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
                ...
                <!-- Hero Text Content (Ringkas, Rapi, & Ukuran Pas) -->
                <div class="lg:col-span-7 text-center lg:text-left">
                    
                    <!-- Official Live Badge -->
                    <div class="reveal active inline-flex items-center gap-2 px-3.5 py-1 rounded-full text-xs font-bold bg-white/10 backdrop-blur-md border border-white/20 text-sky-300 shadow-md mb-4">
                    ...
                    <h1 class="reveal active delay-100 font-display text-2xl sm:text-3xl md:text-4xl font-extrabold text-white mb-3.5 leading-tight tracking-tight">
                        Infrastruktur Jaringan & <br>
                        <span class="bg-gradient-to-r from-sky-300 via-teal-300 to-emerald-400 bg-clip-text text-transparent">Telekomunikasi Handal</span>
                    </h1>

                    <!-- Streamlined Subtitle -->
                    <p class="reveal active delay-200 text-xs sm:text-sm text-sky-100/80 mb-6 max-w-lg mx-auto lg:mx-0 leading-relaxed font-medium">
                    ...
                    <!-- Buttons CTA -->
                    <div class="reveal active delay-300 flex flex-col sm:flex-row gap-3 justify-center lg:justify-start items-center mb-6">
                        <a href="https://wa.me/628218973458?text=Halo%20PT%20Connecti%20Jelajah%20Priangan,%20saya%20ingin%20konsultasi%20layanan%20jaringan" target="_blank" rel="noopener" class="btn-glow bg-gradient-to-r from-emerald-500 to-teal-600 text-white px-6 py-3 rounded-full font-bold text-xs shadow-xl shadow-emerald-900/40 flex items-center gap-2 hover:scale-105 active:scale-95 transition-all w-full sm:w-auto justify-center">
                            <i class="fa-brands fa-whatsapp text-lg"></i>
                            <span>Konsultasi via WhatsApp</span>
                        </a>
                        <a href="#produk" class="px-6 py-3 rounded-full border border-white/25 text-white font-bold text-xs bg-white/10 backdrop-blur-md hover:bg-white/20 transition duration-300 w-full sm:w-auto text-center shadow-md">
                            Katalog Layanan
                        </a>
                    </div>

                    <!-- 3 Key Features Highlights Bar -->
                    <div class="reveal active delay-400 flex flex-wrap justify-center lg:justify-start items-center gap-5 pt-5 border-t border-white/15 text-xs font-semibold text-sky-200">
                        <div class="flex items-center gap-1.5">
                            <span class="w-4 h-4 rounded-full bg-emerald-400/20 text-emerald-300 flex items-center justify-center text-[9px] font-bold border border-emerald-400/30">✓</span>
                            <span>Anggota APJATEL</span>
                        </div>
                        <div class="flex items-center gap-1.5">
                            <span class="w-4 h-4 rounded-full bg-sky-400/20 text-sky-300 flex items-center justify-center text-[9px] font-bold border border-sky-400/30">✓</span>
                            <span>Bandung, Jawa Barat</span>
                        </div>
                        <div class="flex items-center gap-1.5">
                            <span class="w-4 h-4 rounded-full bg-teal-400/20 text-teal-300 flex items-center justify-center text-[9px] font-bold border border-teal-400/30">✓</span>
        ...
        <div class="absolute bottom-0 left-0 w-full overflow-hidden leading-none z-10 pointer-events-none">
            <svg class="relative block w-full h-8 sm:h-12 md:h-16" viewBox="0 0 1200 120" preserveAspectRatio="none">
                <path d="M0,0 C150,90 350,-30 500,45 C680,125 920,15 1200,40 L1200,120 L0,120 Z" fill="#ffffff"></path>
            </svg>
        </div>
    </section>

    <!-- Section Profil Perusahaan & Layanan Utama (Tentang Kami) -->
    <section id="tentang" class="py-20 bg-white px-6 relative overflow-hidden">
    ...
    <section id="produk" class="pt-24 pb-28 md:pb-36 bg-gradient-produk px-6 relative overflow-hidden">
        ...
        <!-- Subtle Ambient Cyber Grid Overlay -->
        <div class="absolute inset-0 pointer-events-none opacity-15" style="background-image: radial-gradient(circle, rgba(255,255,255,0.2) 1px, transparent 1px); background-size: 32px 32px;"></div>
        ...
        <div class="container mx-auto max-w-6xl relative z-10">
            ...
            @php
                $officialServices = [
                    [
                        ...
                        'bg' => 'bgcard.jpg',
                        'wa_text' => 'Halo%20PT%20CJP,%20saya%20tertarik%20dengan%20layanan%20Site%20Installation%20%26%20Pemetaan%20Perangkat',
                        'details' => [
                            ...
                            'Quality Control & Testing Nonstop 24/7',
                        ],
                    ],
                    [
                        ...
                        'bg' => 'bgcard2.jpg',
                        'wa_text' => 'Halo%20PT%20CJP,%20saya%20tertarik%20dengan%20layanan%20Pengelolaan%20Administrasi%20%26%20Perizinan%20Proyek',
                        'details' => [
                    ...
                    [
                        ...
                        'bg' => 'bgcard3.jpg',
                        'wa_text' => 'Halo%20PT%20CJP,%20saya%20tertarik%20dengan%20layanan%20Kemitraan%20Jaringan%20Regional%20Jawa%20Barat',
                        'details' => [
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
                ...
                @endphp
                <div class="reveal shine-card card-hover bg-white p-7 sm:p-8 rounded-3xl border border-sky-100 shadow-sm relative overflow-hidden flex flex-col justify-between group transform-gpu" style="transition-delay: {{ $delay }};">
                    
                    <!-- GPU Accelerated Isolated Background Image Layer -->
                    <div class="absolute inset-0 bg-cover bg-center opacity-20 group-hover:opacity-30 group-hover:scale-105 transition-all duration-500 pointer-events-none transform-gpu" style="background-image: url('{{ asset('assets/' . $srv['bg']) }}');"></div>
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="flex justify-between items-center mb-5">
                            <span class="px-3 py-1 rounded-full text-[11px] font-bold uppercase tracking-wider text-[color:var(--sky-deep)] bg-sky-100/90 border border-sky-200 shadow-2xs">
                                {{ $srv['tag'] }}
                            </span>
                    ...
                    <!-- Direct WhatsApp Button for each product -->
                    <a href="https://wa.me/628218973458?text={{ $srv['wa_text'] }}" target="_blank" rel="noopener" class="relative z-10 w-full mt-4 text-center py-3 rounded-xl border border-emerald-300 text-white font-bold text-xs uppercase tracking-wider bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 shadow-md hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-95">
                        <i class="fa-brands fa-whatsapp text-base"></i>
                        <span>Konsultasi via WhatsApp</span>
                    </a>
                </div>
        ...
        <!-- Produk Bottom Seamless Dark Wave Divider into Portofolio -->
        <div class="absolute bottom-0 left-0 w-full overflow-hidden leading-none z-10 pointer-events-none translate-y-px">
            <svg class="relative block w-full h-8 sm:h-12 md:h-16" viewBox="0 0 1200 120" preserveAspectRatio="none">
                <path d="M0,0 C150,90 350,-30 500,45 C680,125 920,15 1200,40 L1200,120 L0,120 Z" fill="#081F38"></path>
            </svg>
        </div>
    </section>

    <!-- Section Portofolio Proyek -->
    <section id="portofolio" class="relative pt-12 pb-24 sm:pt-16 sm:pb-28 px-4 sm:px-6 overflow-hidden" style="background: linear-gradient(180deg, #081F38 0%, #0B2A4A 35%, #11426C 70%, #081F38 100%);">
        ...
        <!-- Portofolio Bottom Curved Shape Divider -->
        <div class="absolute bottom-0 left-0 w-full overflow-hidden leading-none z-10 pointer-events-none">
            <svg class="relative block w-full h-8 sm:h-12 md:h-14" viewBox="0 0 1200 120" preserveAspectRatio="none">
                <path d="M0,0 C200,80 450,10 700,60 C950,110 1100,30 1200,55 L1200,120 L0,120 Z" fill="#F4FAFD"></path>
            </svg>
        </div>
    </section>

    <!-- Section Klien Kami -->
    <section id="klien" class="py-20 bg-mist px-6">
    ...
    <section id="kontak" class="pt-6 pb-20 sm:pt-8 sm:pb-24 bg-mist px-6 border-t border-sky-100">
        <div class="container mx-auto max-w-5xl">
            <div class="reveal shine-card bg-white rounded-3xl shadow-xl overflow-hidden md:flex border border-sky-100">
                ...
                <!-- Info Panel Kiri -->
                <div class="p-6 sm:p-8 md:p-10 md:w-5/12 text-white flex flex-col justify-between relative overflow-hidden" style="background: linear-gradient(160deg, var(--sky-deep) 0%, var(--ink) 100%);">
                    <div class="relative z-10">
                        <span class="px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider text-sky-200 bg-white/10 border border-white/20 inline-block mb-3 sm:mb-4">
                            Hubungi Kami
                        </span>
                        <h3 class="font-display text-xl sm:text-2xl md:text-3xl font-extrabold mb-3 sm:mb-4 leading-snug">Ada Pertanyaan & Saran?</h3>
                        <p class="text-sky-100/90 text-xs sm:text-sm mb-6 sm:mb-8 leading-relaxed">Tim dukungan kami siap membantu Anda 24/7. Silakan isi formulir di samping untuk informasi lebih lanjut.</p>
    ...
    <section id="lokasi" class="py-16 sm:py-24 bg-white px-6 border-t border-sky-100">
        <div class="container mx-auto max-w-5xl">
            <div class="reveal text-center mb-10 sm:mb-16">
                <span class="eyebrow justify-center mb-3">Lokasi Operasional</span>
                <h2 class="font-display text-2xl sm:text-3xl md:text-4xl font-extrabold text-[color:var(--ink)] tracking-tight">Lokasi Kantor & Head Office</h2>
                <p class="mt-2.5 sm:mt-3 text-gray-600 max-w-xl mx-auto text-xs sm:text-sm md:text-base">Kunjungi kantor operasional kami atau buka petunjuk arah langsung melalui Google Maps.</p>
            </div>
    ...
    <div class="relative w-full overflow-hidden leading-none pointer-events-none -mb-1 z-10" style="background-color: #ffffff;">
        <svg class="relative block w-full h-8 sm:h-12 md:h-14" viewBox="0 0 1200 120" preserveAspectRatio="none">
            <path d="M0,0 C300,85 600,10 900,70 C1050,100 1150,40 1200,25 L1200,120 L0,120 Z" fill="var(--ink)"></path>
        </svg>
    </div>

    <!-- Footer Multi-Kolom -->
    <footer class="text-gray-300 pt-12 pb-12 px-6" style="background: var(--ink);">
