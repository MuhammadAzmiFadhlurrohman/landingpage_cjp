...
<body class="font-sans text-[15px] leading-relaxed antialiased text-[color:var(--ink)]">
    ...
    <section id="portofolio" class="relative py-28 px-4 sm:px-6 overflow-hidden" style="background: linear-gradient(135deg, #081F38 0%, #0B2A4A 40%, #11426C 75%, #1C8AC0 100%);">
        
        <!-- Portofolio Top Curved Shape Divider -->
        <div class="absolute top-0 left-0 w-full overflow-hidden leading-none z-10 pointer-events-none rotate-180">
            <svg class="relative block w-full h-8 sm:h-12 md:h-14" viewBox="0 0 1200 120" preserveAspectRatio="none">
                <path d="M0,0 C180,75 420,-20 620,40 C820,100 1020,20 1200,50 L1200,120 L0,120 Z" fill="#F4FAFD"></path>
            </svg>
        </div>
